...
\begin{enumerate}[itemsep=1pt,parsep=0pt]
    ...
    \item $\forall m_1, m_2 \in \M, c \in \C, k \pickUAR\footnote{\href{https://math.stackexchange.com/a/1576505}{What does this dollar sign over arrow in function mapping mean?}} \K \implies \Pr[\Enc(k, m_1) \evaluatesto c] = \Pr[\Enc(k, m_2) \evaluatesto c]$.\hfill\refstepcounter{equation}\textup{(\theequation)}\label{eq:perfect-secrecy-3}
\end{enumerate}

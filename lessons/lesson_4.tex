...
\begin{definition}[\ppt{} Turing machine]
...
\end{definition}
%
\begin{definition}[poly function]
...
\begin{solution}
    \todo{
    	This solution uses weak inequalities.
    	However, a function must be strictly lesser than the reciprocal of a polynomial in order to be negligible.
    	Idea: Exploit computational hardness, in particular P $\neq$ NP.
    }
